...
// Source: providers/core/interfaces.go
//
// Generated by this command:
//
//	mockgen -source=providers/core/interfaces.go -destination=tests/mocks/providers/management.go -package=providersmocks
//
...
func (m *MockIProvider) ChatCompletions(ctx context.Context, clientReq types.CreateChatCompletionRequest) (types.CreateChatCompletionResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ChatCompletions", ctx, clientReq)
	ret0, _ := ret[0].(types.CreateChatCompletionResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockIProvider) GetID() *types.Provider {
	m.ctrl.T.Helper()
...
func (m *MockIProvider) ListModels(ctx context.Context) (types.ListModelsResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListModels", ctx)
	ret0, _ := ret[0].(types.ListModelsResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
