...
| ENABLE_AUDIO                 | `false`       | Enable the Audio API (POST /v1/audio/speech). When disabled, the endpoint returns a 404. Only providers with speech support (currently openai) can serve this endpoint                                                   |
