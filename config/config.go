...
type Config struct {
	...
	AudioEnabled              bool   `env:"AUDIO_ENABLED, default=false" description:"Enable the Audio API (POST /v1/audio/speech, POST /v1/audio/sfx). When disabled, the endpoints return a 404. Served by providers with speech or sound-effect support (currently openai and elevenlabs) or by the local llama-tts engine"`
