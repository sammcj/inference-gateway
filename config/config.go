...
type Config struct {
	...
	AudioEnabled              bool   `env:"AUDIO_ENABLED, default=false" description:"Enable the Audio API (POST /v1/audio/speech). When disabled, the endpoint returns a 404. Served by providers with speech support (currently openai) or by the local llama-tts engine"`
