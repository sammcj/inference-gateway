...
type Config struct {
	...
	EnableAudio               bool   `env:"ENABLE_AUDIO, default=false" description:"Enable the Audio API (POST /v1/audio/speech). When disabled, the endpoint returns a 404. Only providers with speech support (currently openai) can serve this endpoint"`
